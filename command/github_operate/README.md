...
- [Github Operate](#github-operate)
  ...
  - [如何让朋友可以查看自己的私人仓库:](#如何让朋友可以查看自己的私人仓库)
  - [链接下划线去除：](#链接下划线去除)
...
要让您的朋友能够查看您在GitHub上创建的私人仓库，您需要执行以下步骤：<br>
...
1. **邀请合作者：** 
   ...
   - 在弹出的对话框中输入您朋友的GitHub用户名或其注册的电子邮件地址。
   - 点击 "Add [username/email]"（添加 [用户名/邮箱]）。

2. **接受邀请：** 
   - 您的朋友将收到一封电子邮件通知，说明他们被邀请成为您的仓库合作者。
   - 他们需要点击邮件中的链接并接受邀请。

3. **设置合适的权限：**
   - 您可以选择授予合作者不同级别的访问权限。通常，您的朋友可能需要读取（Read）或者写入（Write）权限，具体取决于您希望他们能够做什么。

4. **访问仓库：**
   - 一旦接受邀请并被授予权限，您的朋友就可以在他们的GitHub账户下找到并访问该私人仓库。

确保您的朋友有一个GitHub账户，并且他们已登录到该账户，以便接受邀请并访问您的私人仓库。<br>
